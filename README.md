...
* support insert dylib、class-dump、restore-symbol、reveal/lookin、cycript，patch and debug iOS Apps, without jailbreak.
...
* 只需拖入一个砸壳应用，自动集成class-dump、restore-symbol、Reveal/Lookin、Cycript和注入的动态库并重签名安装到非越狱机器。
* 支持调试自己编写的动态库和第三方App
